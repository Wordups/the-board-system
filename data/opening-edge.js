...
// snapshot (2026-08-29T02:54:28.603Z); do not hand-edit. Regenerate with a slate:
  ...
  "games": [
    {
      ...
      "homeTip": 64.9,
      "edge": "POR +5.1pp",
      "note": "ATL scores first in 44% of games, POR in 49%. POR missing Karlie Samuelson, Frieda Buhner, Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin; ATL missing Angel Reese Suspension, Indya Nivar, Brionna Jones, DeWanna Bonner.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 42.4,
      "edge": "LVA +9.8pp",
      "note": "LVA scores first in 59% of games, TOR in 49%. TOR missing Nyara Sabally, Maria Conde, Julie Allemand, Marina Mabrey, Aneesah Morrow, Brittney Sykes; LVA missing Ta'Niya Latson, NaLyssa Smith.",
      "chain": {
        "away": {
        ...
        "home": {
          "jumper": "A'ja Wilson 1/41 — NaLyssa Smith out",
    ...
    },
    {
      ...
      "homeTip": 35.7,
      "edge": "WAS +6.3pp",
      "note": "LA scores first in 46% of games, WAS in 53%. LA missing Alissa Pili.",
      "chain": {
        "away": {
