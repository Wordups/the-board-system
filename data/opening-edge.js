...
// snapshot (2026-08-23T20:55:02.162Z); do not hand-edit. Regenerate with a slate:
  ...
  "picks": [
    {
      ...
      "cautions": [
        "Injury report: Shakira Austin Day-To-Day"
      ]
    },
    {
    ...
    },
    {
      ...
      "shot": 18,
      "make": 57,
      "script": "LVA wins 43% of tips and scores first in 60% of games; Gray takes the first shot in 18% and converts 57% of those attempts.",
      "signals": [
  ...
  "games": [
    {
      ...
      "homeTip": 37.6,
      "edge": "Even lean",
      "note": "DAL scores first in 55% of games, SEA in 57%. SEA missing Natisha Hiedeman; DAL missing Alanna Smith, Azzi Fudd, Aziaha James, Costanza Verona.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 51.8,
      "edge": "IND +9.2pp",
      "note": "CHI scores first in 51% of games, IND in 61%. IND missing Myisha Hines-Allen, Caitlin Clark, Aliyah Boston; CHI missing DiJonai Carrington, Skylar Diggins, Rickea Jackson.",
      "chain": {
        "away": {
          "jumper": "Makayla Timpson 6/36 — Aliyah Boston out",
    ...
    },
    {
      ...
      "homeTip": 36.1,
      "edge": "WAS +5.4pp",
      "note": "POR scores first in 49% of games, WAS in 54%. WAS missing Shakira Austin; POR missing Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin.",
      "chain": {
        "away": {
          "jumper": "Shakira Austin 33/36 (DTD)",
    ...
    },
    {
      ...
      "homeTip": 56,
      "edge": "LVA +14.1pp",
      "note": "TOR scores first in 46% of games, LVA in 60%. LVA missing A'ja Wilson, Dana Evans; TOR missing Aneesah Morrow, Maria Conde, Brittney Sykes, Marina Mabrey, Nyara Sabally.",
      "chain": {
        "away": {
