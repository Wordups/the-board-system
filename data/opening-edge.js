...
// snapshot (2026-08-28T23:40:00.994Z); do not hand-edit. Regenerate with a slate:
  ...
  "games": [
    {
      ...
      "homeTip": 64.9,
      "edge": "POR +5.1pp",
      "note": "ATL scores first in 44% of games, POR in 49%. POR missing Frieda Buhner, Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin; ATL missing Indya Nivar, Brionna Jones, DeWanna Bonner.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 44.2,
      "edge": "IND +10.3pp",
      "note": "IND scores first in 62% of games, CON in 51%. CON missing Rayah Marshall, Olivia Nelson-Ododa, Brittney Griner, Kennedy Burke, Leila Lacan.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 42.4,
      "edge": "LVA +9.8pp",
      "note": "LVA scores first in 59% of games, TOR in 49%. TOR missing Nyara Sabally, Maria Conde, Julie Allemand, Marina Mabrey, Aneesah Morrow, Brittney Sykes; LVA missing Dana Evans, A'ja Wilson, NaLyssa Smith.",
      "chain": {
        "away": {
          "jumper": "Isabelle Harrison 15/38 — Nyara Sabally out",
