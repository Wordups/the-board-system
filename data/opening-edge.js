...
// snapshot (2026-08-18T15:05:10.793Z); do not hand-edit. Regenerate with a slate:
...
window.OPENING_EDGE = {
  ...
  "picks": [
    ...
    },
    {
      ...
      "cautions": [
        "Injury report: Sabrina Ionescu Day-To-Day",
        "Tip disadvantage vs CHI"
      ]
    }
  ],
  "games": [
    {
      ...
      "chain": {
        ...
        "home": {
          "jumper": "Brittney Griner 18/33 (DTD)",
          "gainer": "Diamond Miller 6/26 · 2 first FGs",
          "shooter": "Brittney Griner 8/34"
        }
      }
    },
    {
      ...
      "homeTip": 46.9,
      "edge": "IND +15.8pp",
      "note": "TOR scores first in 47% of games, IND in 63%. IND missing Aliyah Boston, Caitlin Clark, Damiris Dantas; TOR missing Maria Conde, Julie Allemand, Brittney Sykes, Nyara Sabally.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 50.9,
      "edge": "NYL +6.5pp",
      "note": "CHI scores first in 51% of games, NYL in 58%. NYL missing Satou Sabally, Sabrina Ionescu, Leonie Fiebich; CHI missing Sydney Taylor, Skylar Diggins, Rickea Jackson.",
      "chain": {
        "away": {
  ...
  "marketMap": [
    {
      ...
      "topPick": "Brittney Griner · 38 edge · +1033",
      "tdWatch": "—"
    },
    {
      "game": "IND @ TOR",
