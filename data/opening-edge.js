...
// snapshot (2026-09-18T17:52:04.947Z); do not hand-edit. Regenerate with a slate:
  ...
  "games": [
    {
      ...
      "homeTip": 48.3,
      "edge": "IND +13.7pp",
      "note": "TOR scores first in 49% of games, IND in 63%. IND missing Caitlin Clark; TOR missing Maria Conde, Marina Mabrey, Aneesah Morrow, Brittney Sykes.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 26.2,
      "edge": "NYL +20.6pp",
      "note": "MIN scores first in 37% of games, NYL in 57%. NYL missing Satou Sabally; MIN missing Anastasiia Olairi Kosu.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 57.1,
      "edge": "Even lean",
      "note": "GSV scores first in 48% of games, POR in 48%. POR missing Megan DiLeo, Teja Oblak, Bridget Carleton, Carla Leite, Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin; GSV missing Janelle Salaun, Gabby Williams, Cecilia Zandalasini, Iliana Rupert.",
      "chain": {
        "away": {
          "jumper": "Serah Williams 3/40 — Megan DiLeo out",
          "gainer": "Emily Engstler 4/15 · 6 first FGs",
          "shooter": "Emily Engstler 7/42"
        },
        "home": {
