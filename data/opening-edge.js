...
// snapshot (2026-08-07T22:46:39.153Z); do not hand-edit. Regenerate with a slate:
...
window.OPENING_EDGE = {
  ...
  "picks": [
    ...
    },
    {
      ...
      "shot": 32,
      "make": 50,
      "script": "ATL wins 61% of tips and scores first in 39% of games; Howard takes the first shot in 32% and converts 50% of those attempts.",
      "signals": [
    ...
    },
    {
      ...
      "shot": 16,
      "make": 40,
      "script": "CON wins 74% of tips and scores first in 48% of games; Miller takes the first shot in 16% and converts 40% of those attempts.",
      "signals": [
  ...
  "games": [
    {
      ...
      "homeTip": 64.6,
      "edge": "CON +10.9pp",
      "note": "CON scores first in 48% of games, PHX in 38%. PHX missing Jovana Nogic; CON missing Olivia Nelson-Ododa, Raegan Beers, Brittney Griner, Maria Kliundikova.",
      "chain": {
        "away": {
          "jumper": "Natasha Mack 18/31",
          "gainer": "Alyssa Thomas 9/13",
          "shooter": "Kahleah Copper 7/32"
        },
        "home": {
          "jumper": "Olivia Nelson-Ododa 9/30 (DTD) — Brittney Griner out",
          "gainer": "Diamond Miller 6/23",
          "shooter": "Diamond Miller 5/31"
        }
      }
    },
    {
      ...
      "homeTip": 52.1,
      "edge": "WAS +21.3pp",
      "note": "WAS scores first in 60% of games, ATL in 39%. ATL missing Indya Nivar, Te-Hina Paopao.",
      "chain": {
        "away": {
          "jumper": "Angel Reese 27/28",
          "gainer": "Jordin Canada 10/19",
          "shooter": "Rhyne Howard 10/31"
        },
        "home": {
          "jumper": "Shakira Austin 26/29",
          "gainer": "Kiki Iriafen 9/20",
          "shooter": "Shakira Austin 10/30"
        }
      }
    },
    {
      ...
      "chain": {
        "away": {
          "jumper": "Kiah Stokes 30/30",
          "gainer": "Veronica Burton 8/15",
          "shooter": "Kayla Thornton 8/30"
        },
        "home": {
          "jumper": "Awak Kuier 14/30",
          "gainer": "Jessica Shepard 4/10",
          "shooter": "Paige Bueckers 8/32"
        }
      }
    }
  ],
  ...
  "marketMap": [
    {
      ...
      "topPick": "Leila Lacan · 36 edge · +933",
  ...
  "sim": {
    "runs": 1000,
    "missBranch": "56/125 missed first attempts stayed with the shooting team; 12/56 finished by the same shooter",
    "games": [
      {
        "game": "PHX @ CON",
        "top": [
