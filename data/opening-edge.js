...
// snapshot (2026-08-30T22:54:53.038Z); do not hand-edit. Regenerate with a slate:
...
window.OPENING_EDGE = {
  ...
  "games": [
    ...
    },
    {
      ...
      "homeTip": 62.4,
      "edge": "SEA +6.3pp",
      "note": "SEA scores first in 54% of games, LA in 48%. LA missing Aaliyah Nye; SEA missing Natisha Hiedeman, Awa Fam.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 40,
      "edge": "Even lean",
      "note": "POR scores first in 48% of games, GSV in 46%. GSV missing Cecilia Zandalasini, Janelle Salaun, Gabby Williams, Iliana Rupert; POR missing Carla Leite, Frieda Buhner, Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 34.1,
      "edge": "DAL +7.5pp",
      "note": "DAL scores first in 57% of games, CON in 50%. CON missing Olivia Nelson-Ododa, Brittney Griner, Kennedy Burke, Leila Lacan; DAL missing Azzi Fudd, Costanza Verona.",
      "chain": {
        "away": {
