...
// snapshot (2026-09-20T17:39:33.834Z); do not hand-edit. Regenerate with a slate:
  ...
  "games": [
    {
      ...
      "homeTip": 76.9,
      "edge": "CON +11.9pp",
      "note": "CON scores first in 48% of games, MIN in 36%. MIN missing Elena Buenavida, Anastasiia Olairi Kosu; CON missing Rayah Marshall, Brittney Griner, Olivia Nelson-Ododa, Kennedy Burke.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 47.6,
      "edge": "NYL +10.5pp",
      "note": "TOR scores first in 48% of games, NYL in 58%. NYL missing Satou Sabally; TOR missing Marina Mabrey, Aneesah Morrow, Brittney Sykes.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 49.6,
      "edge": "IND +13.4pp",
      "note": "IND scores first in 63% of games, WAS in 50%. IND missing Caitlin Clark.",
      "chain": {
        "away": {
    ...
    },
    {
      ...
      "homeTip": 48.9,
      "edge": "Even lean",
      "note": "LA scores first in 48% of games, POR in 47%. POR missing Bridget Carleton, Teja Oblak, Jordan Harrison, Luisa Geiselsoder, Sarah Ashlee Barker, Sania Feagin; LA missing Aaliyah Nye, Cameron Brink, Dearica Hamby.",
      "chain": {
        "away": {
        ...
        "home": {
          "jumper": "Dearica Hamby 40/41 (DTD)",
          "gainer": "Rae Burrell 4/14 · 4 first FGs",
          "shooter": "Dearica Hamby 10/42"
        }
      }
    },
    {
      ...
      "homeTip": 41.9,
      "edge": "LVA +8.1pp",
      "note": "LVA scores first in 58% of games, SEA in 50%. SEA missing Zia Cooke, Jordan Horston, Katie Lou Samuelson, Ezi Magbegor; LVA missing NaLyssa Smith.",
      "chain": {
        "away": {
