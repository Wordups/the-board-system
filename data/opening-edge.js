...
// snapshot (2026-09-23T23:06:59.495Z); do not hand-edit. Regenerate with a slate:
...
window.OPENING_EDGE = {
  ...
  "picks": [
    ...
    },
    {
      ...
      "shot": 9,
      "make": 50,
      "script": "DAL wins 39% of tips and scores first in 59% of games; Kuier takes the first shot in 9% and converts 50% of those attempts.",
      "signals": [
  ...
  "games": [
    {
      ...
      "homeTip": 51.3,
      "edge": "NYL +14.6pp",
      "note": "NYL scores first in 58% of games, ATL in 43%. ATL missing Matilde Villa, Brionna Jones; NYL missing Satou Sabally, Breanna Stewart, Elizabeth Balogun.",
      "chain": {
        "away": {
